...
const languageOptions = [
  { value: 'en', label: 'English', icon: '../../../icons/britain_icon.png' },
  { value: 'uk', label: 'Українська', icon: '../../../icons/n_ukraine_ico.png' },
  { value: 'cze', label: 'Čeština', icon: '../../../icons/1_icon-czech-republic.png' },
];
